 ...
 */
class ClientMessageDecoder(private val socialCodec: List<Triple<Int, Int, Boolean>>, codec: HandshakeCodec, handshake: MessageHandshake) : SimpleMessageHandshakeDecoder(codec, handshake) {
