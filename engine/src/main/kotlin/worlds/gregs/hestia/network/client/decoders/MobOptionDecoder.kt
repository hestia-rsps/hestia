...
class MobOptionDecoder : MessageDecoder<MobOptionMessage>(3, MOB_OPTION_1, MOB_OPTION_2, MOB_OPTION_3, MOB_OPTION_4, MOB_OPTION_5, MOB_OPTION_6) {

    override fun decode(ctx: ChannelHandlerContext, packet: Packet): MobOptionMessage? {
        return MobOptionMessage(packet.readBoolean(Modifier.ADD), packet.readShort(Modifier.ADD), opcodes.indexOf(packet.opcode) + 1)
    }
