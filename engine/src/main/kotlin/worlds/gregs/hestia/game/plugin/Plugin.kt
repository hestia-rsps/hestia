...
interface Plugin : ArtemisPlugin {
    ...
    companion object {
        ...
        const val POST_TASK_PROCESS_PRIORITY = WorldConfigurationBuilder.Priority.HIGHEST - 3
        ...
        const val INTERFACE_PRIORITY = 9000

        const val PRE_SYNC_PRIORITY = 8900

        const val UPDATE_GLOBAL_ENTITY_PRIORITY = 8800
        const val UPDATE_FLAG_PRIORITY = 8700
        const val UPDATE_DISPLAY_FLAG_PRIORITY = 8600
        const val UPDATE_DISPLAY_CHANGE_PRIORITY = 8500
        const val UPDATE_SYNC_PRIORITY = 8400
        const val UPDATE_UPDATE_PRIORITY = 8300
        const val UPDATE_CHANGE_PRIORITY = 8200
        const val UPDATE_FINISH_PRIORITY = 8100
