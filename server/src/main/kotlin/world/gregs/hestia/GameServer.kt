...
import world.gregs.hestia.game.Engine
import world.gregs.hestia.game.plugin.PluginLoader
import world.gregs.hestia.game.archetypes.EntityFactory
import world.gregs.hestia.network.GamePacketInboundHandler
import world.gregs.hestia.network.LoginAttempt
import world.gregs.hestia.network.LoginServerInboundHandler
import world.gregs.hestia.network.WorldChangeListener
import world.gregs.hestia.network.login.Filter
...
class GameServer(info: WorldDetails) : Engine(), WorldChangeListener {
    ...
    init {
        ...
        val worldPackets = loader.load("world.gregs.hestia.network.world.in")
...
//            config.register()
            ...
            val gamePackets = pluginLoader.load("world.gregs.hestia.network.in")
