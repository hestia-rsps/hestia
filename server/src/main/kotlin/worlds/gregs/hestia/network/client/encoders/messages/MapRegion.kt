 ...
 */
data class MapRegion(val entity: Int, val chunkX: Int, val chunkY: Int, val forceReload: Boolean, val mapSize: Int, val mapHash: Int, val login: (PacketBuilder.(Int) -> Unit)?) : Message