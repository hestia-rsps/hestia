package worlds.gregs.hestia.game.update.block
 ...
 */
abstract class BlockFactory<T : UpdateBlock>(aspect: Aspect.Builder, val added: Boolean = false, val mob: Boolean = false, internal val flag: Int) : BaseEntitySystem(aspect) {
