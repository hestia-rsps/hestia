...
import worlds.gregs.hestia.game.map.Flags.BLOCKED
import worlds.gregs.hestia.game.map.Flags.BLOCKED_NORTH_EAST
import worlds.gregs.hestia.game.map.Flags.BLOCKED_NORTH_WEST
import worlds.gregs.hestia.game.map.Flags.BLOCKED_SOUTH_EAST
import worlds.gregs.hestia.game.map.Flags.BLOCKED_SOUTH_WEST
import worlds.gregs.hestia.game.map.Flags.CLEAR_EAST
import worlds.gregs.hestia.game.map.Flags.CLEAR_NORTH
import worlds.gregs.hestia.game.map.Flags.CLEAR_SOUTH
import worlds.gregs.hestia.game.map.Flags.CLEAR_WEST
import worlds.gregs.hestia.game.map.Flags.CORNER_OBJ_NORTH_EAST_BLOCKS_WALK_ALTERNATIVE
import worlds.gregs.hestia.game.map.Flags.CORNER_OBJ_NORTH_WEST_BLOCKS_WALK_ALTERNATIVE
import worlds.gregs.hestia.game.map.Flags.CORNER_OBJ_SOUTH_EAST_BLOCKS_WALK_ALTERNATIVE
import worlds.gregs.hestia.game.map.Flags.CORNER_OBJ_SOUTH_WEST_BLOCKS_WALK_ALTERNATIVE
import worlds.gregs.hestia.game.map.Flags.WALL_OBJ_EAST_BLOCKS_WALK_ALTERNATIVE
import worlds.gregs.hestia.game.map.Flags.WALL_OBJ_NORTH_BLOCKS_WALK_ALTERNATIVE
import worlds.gregs.hestia.game.map.Flags.WALL_OBJ_SOUTH_BLOCKS_WALK_ALTERNATIVE
import worlds.gregs.hestia.game.map.Flags.WALL_OBJ_WEST_BLOCKS_WALK_ALTERNATIVE
...
enum class Direction(val deltaX: Int, val deltaY: Int, val value: Int, val mask: Int) {
    ...
    fun reverse(): Direction {
        return fromDirection(7 - ordinal) ?: NONE
    }
