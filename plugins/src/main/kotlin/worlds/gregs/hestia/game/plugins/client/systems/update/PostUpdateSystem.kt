...
class PostUpdateSystem : IteratingSystem(Aspect.all(NetworkSession::class, Viewport::class)) {
    ...
    override fun process(entityId: Int) {
        ...
        clientPlayerPacketMapper.get(entityId).packet = PacketWriter(69, Packet.Type.VAR_SHORT)
        clientMobPacketMapper.get(entityId).packet = PacketWriter(6, Packet.Type.VAR_SHORT)
