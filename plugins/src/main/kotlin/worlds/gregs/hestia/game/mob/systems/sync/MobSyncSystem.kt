...
import worlds.gregs.hestia.game.mob.systems.sync.MobViewDistanceSystem.Companion.MAXIMUM_LOCAL_MOBS
...
class MobSyncSystem : MobUpdateSystem(Aspect.all(NetworkSession::class, Renderable::class, Viewport::class)) {
    ...
    override fun globalCheck(entityId: Int, global: Int): Boolean {
        return when {
            ...
            added >= worlds.gregs.hestia.game.mob.systems.sync.MobSyncSystem.Companion.NEW_MOBS_PER_CYCLE -> false
            else -> true
        }
    }
