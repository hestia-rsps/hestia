...
import worlds.gregs.hestia.game.plugins.widget.components.tabs.ConquestCommandsTab
import worlds.gregs.hestia.game.plugins.widget.systems.BaseTab

class ConquestCommandsTabSystem : BaseTab(ConquestCommandsTab::class) {
