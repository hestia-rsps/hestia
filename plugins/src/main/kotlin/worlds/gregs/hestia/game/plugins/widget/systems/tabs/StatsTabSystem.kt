...
import worlds.gregs.hestia.game.plugins.widget.components.tabs.StatsTab
...
import worlds.gregs.hestia.network.out.SkillLevel
import worlds.gregs.hestia.services.send
import kotlin.math.pow

@Wire(failOnNull = false, injectInherited = true)
class StatsTabSystem : BaseTab(StatsTab::class) {
