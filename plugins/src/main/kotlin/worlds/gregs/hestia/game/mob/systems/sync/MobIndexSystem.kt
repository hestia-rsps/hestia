...
import worlds.gregs.hestia.game.player.systems.sync.PlayerIndexSystem.Companion.ENTITY_LIMIT
...
class MobIndexSystem : SubscriptionSystem(Aspect.all(ClientIndex::class, Mob::class)) {
    ...
    override fun inserted(entityId: Int) {
        ...
        if(index > worlds.gregs.hestia.game.mob.systems.sync.MobIndexSystem.Companion.MOBS_LIMIT) {
            throw worlds.gregs.hestia.game.mob.systems.sync.MaximumMobLimitReached()
        }
