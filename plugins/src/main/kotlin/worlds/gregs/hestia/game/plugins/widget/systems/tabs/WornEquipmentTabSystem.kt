...
import worlds.gregs.hestia.game.plugins.widget.components.tabs.WornEquipmentTab
...
class WornEquipmentTabSystem : BaseTab(WornEquipmentTab::class) {

    override var id = EQUIP_TAB_ID
