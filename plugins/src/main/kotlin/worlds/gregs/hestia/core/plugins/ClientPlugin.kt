...
import worlds.gregs.hestia.core.plugins.client.systems.network.ClientConnectSystem
import worlds.gregs.hestia.core.plugins.client.systems.network.ClientDisconnectSystem
import worlds.gregs.hestia.core.plugins.client.systems.network.ClientNetworkSystem
import worlds.gregs.hestia.core.plugins.client.systems.network.PacketSender
import worlds.gregs.hestia.core.plugins.client.systems.network.`in`.*
import worlds.gregs.hestia.core.plugins.client.systems.region.ClientRegionChangeSystem
import worlds.gregs.hestia.core.plugins.client.systems.region.ClientRegionLoadSystem
import worlds.gregs.hestia.core.plugins.client.systems.region.RegionSenderSystem

class ClientPlugin : Plugin {

    override fun setup(b: WorldConfigurationBuilder) {
        b.with(ConsoleCommandHandler(), WidgetOptionHandler(), WalkTargetHandler(), ScreenChangeHandler(), ScreenCloseHandler(), WorldMapOpenHandler(), DialogueContinueHandler(), StringEntryHandler())
