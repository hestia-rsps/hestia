...
class PlayerFactory : ArchetypeFactory {
    ...
    override fun getBuilder(): ArchetypeBuilder {
        return ArchetypeBuilder().add(Player::class, ClientIndex::class, Renderable::class, Position::class, AppearanceData::class, DisplayName::class, Viewport::class, ViewDistance::class, Mobile::class)
    }
}