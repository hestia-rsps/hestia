...
data class ItemDialogue(override val lines: List<String>, override val title: String?, val item: Int, override var continuation: CancellableContinuation<Unit>) : EntityDialogue() {
    init {
