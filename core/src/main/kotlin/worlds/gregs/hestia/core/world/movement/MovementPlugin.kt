package worlds.gregs.hestia.core.world.movement
...
class MovementPlugin : Plugin {
    ...
    override fun setup(b: WorldConfigurationBuilder) {
        ...
        b.with(PRE_NAVIGATION_PRIORITY, RandomWalkSystem(), InteractSystem(), PathSystem())//TODO shouldn't random walk be in it's own pre_strategy and path priority?
