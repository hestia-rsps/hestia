package worlds.gregs.hestia.core.entity.npc.model

import worlds.gregs.hestia.core.display.update.model.Direction

enum class NpcSpawns(val id: Int, val x: Int, val y: Int, val plane: Int = 0, val direction: Direction = Direction.NONE) {
